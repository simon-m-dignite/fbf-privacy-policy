...
const PrivacyPolicy = () => {
  useEffect(() => {
    document.title = "FBF - Privacy Policy";
  }, []);
  return (
    <div className="text-start flex flex-col items-start gap-3">
      <h1 className="heading-size">Privacy Policy</h1>
      <p className="text-sm">Updated at January 1st, 2024</p>

      <p>
        Fitness By Faith (“we,” “our,” or “us”) is committed to protecting your
        privacy. This Privacy Policy explains how your personal information is
        collected, used, and disclosed by Fitness By Faith.
      </p>
      <p>
        This Privacy Policy applies to our app, and its associated subdomains
        (collectively, our “Service”) alongside our application, Fitness By
        Faith. By accessing or using our Service, you signify that you have
      ...
      <ul className="flex flex-col items-start gap-3">
        ...
        <li>
          ...
          41230), that is responsible for your information under this Privacy
          Policy.
        </li>
        <li>
        ...
        <li>
          ...
          to use the Fitness By Faith Service to manage the relationships with
        ...
        <li>
          Personnel: refers to those individuals who are employed by Fitness By
          Faith or are under contract to perform a service on behalf of one of
          the parties.
        </li>
        <li>
      ...
      <h2 className="subheading mt-4">What Information Do We Collect?</h2>
      <p>
      ...
      <h2 className="subheading mt-4">
        When does Fitness By Faith use end user information from third parties?
      </h2>
      <p>
        Fitness By Faith will collect End User Data necessary to provide the
        Fitness By Faith services to our customers. End users may voluntarily
      ...
      <h2 className="subheading mt-4">
        When does Fitness By Faith use customer information from third parties?
      </h2>
      <p>
        ...
        in becoming a Fitness By Faith customer, we receive information from a
        third party that provides automated fraud detection services to Fitness
        By Faith. We also occasionally collect information that is made publicly
      ...
      <p>
        Fitness By Faith will collect personal information that you submit to
      ...
      <h2 className="subheading mt-4">How Do We Use Your Email Address?</h2>
      <p>
      ...
      <h2 className="subheading mt-4">How Long Do We Keep Your Information?</h2>
      <p>
        We keep your information only so long as we need it to provide Fitness
        By Faith to you and fulfill the purposes described in this policy. This
      ...
      <h2 className="subheading mt-4">How Do We Protect Your Information?</h2>
      <p>
        ...
        any information you transmit to Fitness By Faith or guarantee that your
      ...
      <p>
        Fitness By Faith is incorporated in United States. Information collected
        via our app, through direct interactions with you, or from use of our
      ...
      <h2 className="subheading mt-4">
        Is the information collected through the Fitness By Faith Service
        secure?
      </h2>
      <p>
      ...
      <p>
        ...
        Fitness By Faith collects depend on your relationship with Fitness By
        Faith. Personnel may update or correct their information as detailed in
      ...
      <h2 className="subheading mt-4">Personnel</h2>
      <p>
        If you are a Fitness By Faith worker or applicant, we collect
      ...
      <h2 className="subheading mt-4">Sale of Business</h2>
      <p>
        ...
        the assets of Fitness By Faith or any of its Corporate Affiliates (as
        defined herein), or that portion of Fitness By Faith or any of its
      ...
      <h2 className="subheading mt-4">Affiliates</h2>
      <p>
        ...
        Fitness By Faith, whether by ownership or otherwise. Any information
      ...
      <h2 className="subheading mt-4">Governing Law</h2>
      <p>
      ...
      <p>
        By using Fitness By Faith or contacting us directly, you signify your
      ...
      <p>
        ...
        being used. By using our Fitness By Faith, registering an account, or
        making a purchase, you hereby consent to our Privacy Policy and agree to
        its terms.
      </p>

      <h2 className="subheading mt-4">Links to Other Websites</h2>
      <p>
        This Privacy Policy applies only to the Services. The Services may
        contain links to other websites not operated or controlled by Fitness By
        Faith. We are not responsible for the content, accuracy or opinions
      ...
      <h2 className="subheading mt-4">Payment Details</h2>
      <p>
      ...
      <h2 className="subheading mt-4">Kids' Privacy</h2>
      <p>
      ...
      <h2 className="subheading mt-4">Changes To Our Privacy Policy</h2>
      <p>
      ...
      <h2 className="subheading mt-4">Tracking Technologies</h2>
      <ul className="flex flex-col items-start gap-3 list-disc px-4">
        <li>
          Cookies: We use Cookies to enhance the performance and functionality
          of our platform but are non-essential to their use. However, without
      ...
      <h2 className="subheading mt-4">What is GDPR?</h2>
      <p>
      ...
      <h2 className="subheading mt-4">What is personal data?</h2>
      <p>
      ...
      <h2 className="subheading mt-4">Why is GDPR important?</h2>
      <p>
        ...
        At Fitness By Faith we strongly believe that your data privacy is very
      ...
      <p>
        ...
        requirements of GDPR. Fitness By Faith processes or stores all personal
      ...
      <h2 className="subheading mt-4">California Residents</h2>
      <p>
